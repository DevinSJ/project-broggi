                ...
                <b-row>
                    <b-col cols="lg-6">
                        ...
                        <b-form-checkbox
                            ...
                            @change="fetchExpedients(1, false)"
                        >
                    ...
                    <b-col cols="lg-6" class="col-filtrar">
                        <b-form
                            @submit.prevent="fetchExpedients(1, false)"
                            inline
...
export default {
    ...
    methods: {
        ...
        fetchExpedients(page = 1, cleanFilter) {
            if (cleanFilter) {
            ...
            axios
                .get(`api/expedients/?page=${page}&${consulta}`, {
                    cancelToken: axiosSource.token,
                })
                .then((response) => {
        ...
        toggleModalCalls(id_call) {
            const call_selected = this.trucades.find((t) => t.id == id_call);
