<template>
    <div>
            ...
            >
                ...
                <template #cell(see_expedient)="data">
                    <div>
                        ...
                        >
                            <i class="fa-solid fa-eye mr-2"></i> Veure dades
                        </button>
                    </div>
                </template>
            </b-table>
            ...
            >
                <template #cell(cartes_trucades_has_agencies)="data">
                    ...
                    <button
                        ...
                        @click="
                            loadAgencies(data.item.cartes_trucades_has_agencies)
                        "
                    >
        ...
        >
            ...
            <div v-else>
                <p
                    v-for="relacioAgencia in this.agencies_contactades"
                    :key="relacioAgencia.agencia.id"
                >{{ relacioAgencia.agencia.nom }}</p>
            </div>
...
export default {
    ...
    methods: {
        ...
        loadModal(expedient) {
            ...
            axios.get("/api/cartestrucades/list/" +
                this.expedient.id +
                "?id_rol=" +
