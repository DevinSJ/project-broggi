                ...
                <div class="col-lg-8 p-2 position-relative">
                    ...
                    <div class="d-flex justify-content-center w-100 mt-2">
                        <b-button
                            ...
                            :disabled="
                                isVideoLoaded && !showQuestion ? false : true
                            "
                        >
                            <i
                                :class="
...
export default {
        ...
        onTimeUpdateVideo() {
            if (this.$refs.rangeVideo) {
                ...
                if (
                    ...
                    let position =
                        this.$refs[`partVideo${this.currentPartVideo.id}`][0]
                            .$el.offsetTop;
                ...
                switch (Math.round(this.$refs.video.currentTime)) {
                    ...
                    case 33:
                        ...
                        this.showQuestion = true;
                        this.question =
                            "S'haurà de realitzar un procediment específic?";
                        this.$refs.video.pause();
                        this.isPlaying = false;
                        break;
                    case 39:
                    ...
                    case 80:
                        ...
                        this.showQuestion = true;
                        this.question =
                            "Es tracta d'un incident rellevant especial (IRE)?";
                        this.$refs.video.pause();
                        this.isPlaying = false;
                        break;
                    case 113:
                        ...
                        this.showQuestion = true;
                        this.question =
                            "La trucada és una ampliació, reclamació o anulació?";
                        this.$refs.video.pause();
                        this.isPlaying = false;
                        break;
                    case 118:
    ...
    watch: {
        showQuestion(newValue) {
            if (newValue) this.$refs['modal-question'].show();
            else this.$refs['modal-question'].hide();
        }
    }
};
</script>
